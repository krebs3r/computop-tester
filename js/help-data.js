...
const HELP_CONTENT = {
  de: `
    ...
    <section class="help-section" id="help-usage">
      ...
      <ol class="help-steps">
        <li><strong>Credentials eintragen</strong><span>Merchant ID sowie für Classic Blowfish- und HMAC-Passwort oder für REST den API-Key eingeben. Profile werden nur lokal gespeichert.</span></li>
